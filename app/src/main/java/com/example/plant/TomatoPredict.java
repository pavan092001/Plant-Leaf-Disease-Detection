...
import com.example.plant.ml.Tomato;
...
public class TomatoPredict extends AppCompatActivity {
        ...
        treatment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(name.equalsIgnoreCase("Healthy")){
                    ...
                    Toast.makeText(TomatoPredict.this, "Your Plant is Healthy", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    if(image==null)
                    {
                        Toast.makeText(TomatoPredict.this, "Please select Image first", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
    ...
    private void classifyImage(Bitmap image) {
        try {
            ...
            String[] classes = {"Healthy", "Tomato Late blight","Tomato Leaf Mold","Tomato Mosaic virus","Tomato Septoria leaf spot","Tomato Spider mites","Tomato Target Spot","Tomato Yellow Leaf Curl Virus"};
